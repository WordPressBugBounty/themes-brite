...
$brite_theme_divider_style = array(
        ...
        "social_icons" => array(
            ...
            "localProps" => array(
                "icons" => json_encode(array(
                    array(
                        'icon'       => $brite_theme_svg_icons['facebook'],
                        'link_value' => 'http://www.facebook.com/',
                        'index'      => 0,
                    ),
                    array(
                        'icon'       => $brite_theme_svg_icons['twitter'],
                        'link_value' => 'http://www.facebook.com/',
                        'index'      => 1,
                    ),
                    array(
                        'icon'       => $brite_theme_svg_icons['youtube'],
                        'link_value' => 'http://www.youtube.com/',
                        'index'      => 2,
                    ),
                    array(
                        'icon'       => $brite_theme_svg_icons['vimeo'],
        ...
        "icon_list"    => array(
            ...
            "localProps" => array(
                "iconList" => json_encode(array(
                    array(
                        'icon'       => $brite_theme_svg_icons['map-marker'],
                        'text'       => 'Location, State, Country',
                        'link_value' => 'https://maps.google.com/',
                        'index'      => 0,
                    ),
                    array(
                        'icon'       => $brite_theme_svg_icons['phone-square'],
                        'text'       => '(000) 123 12345',
                        'link_value' => 'https://www.twitter.com/',
                        'index'      => 1,
                    ),
                    array(
                        'icon'       => $brite_theme_svg_icons['envelope'],
