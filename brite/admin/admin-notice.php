...
use Brite\SiteLeadsThemeKit\SiteLeads;
...
<div class="brite-admin-big-notice--container">
    ...
    wp_localize_script( $brite_slug , 'brite_builder_status', array(
        ...
        'brite_front_set_predesign_nonce' =>  wp_create_nonce( 'brite_front_set_predesign_nonce' ),
        'brite_disable_big_notice_nonce' => wp_create_nonce( 'brite_disable_big_notice_nonce' ),
